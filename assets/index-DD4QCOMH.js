...
` + e.stack
        ...
        function oc(e, t, n, r, a) {
            if (n.flags |= 32768, typeof r == `object` && r && typeof r.then == `function`) {
                if (t = n.alternate, t !== null && oa(t, n, a, !0), n = uo.current, n !== null) {
                    switch (n.tag) {
                        case 31:
                        case 13:
                            return fo === null ? Du() : n.alternate === null && Y === 0 && (Y = 3), n.flags &= -257, n.flags |= 65536, n.lanes = a, r === Ma ? n.flags |= 16384 : (t = n.updateQueue, t === null ? n.updateQueue = new Set([r]) : t.add(r), Gu(e, r, a)), !1;
                        case 22:
            ...
            if (j) return t = uo.current, t === null ? (r !== Gi && (t = Error(i(423), {
                cause: r
            }), Qi(Di(t, n))), e = e.current.alternate, e.flags |= 65536, a &= -a, e.lanes |= a, r = Di(r, n), a = rc(e.stateNode, r, a), $a(e, a), Y !== 4 && (Y = 2)) : (!(t.flags & 65536) && (t.flags |= 256), t.flags |= 65536, t.lanes = a, r !== Gi && (e = Error(i(422), {
                cause: r
            }), Qi(Di(e, n)))), !1;
            var o = Error(i(520), {
                cause: r
            ...
            do {
                switch (n.tag) {
                    ...
                    case 1:
                        if (t = n.type, o = n.stateNode, !(n.flags & 128) && (typeof t.getDerivedStateFromError == `function` || o !== null && typeof o.componentDidCatch == `function` && (iu === null || !iu.has(o)))) return n.flags |= 65536, a &= -a, n.lanes |= a, a = ic(a), ac(a, e, n, r), $a(n, a), !1
                }
                n = n.return
            } while (n !== null);
            return !1
        ...
        function Ic(e, t, n) {
            ...
            switch (t.lanes = 0, t.tag) {
                ...
                case 9:
                    return a = t.type._context, r = t.pendingProps.children, ca(t), a = la(a), r = r(a), t.flags |= 1, cc(e, t, r, n), t.child;
                case 14:
                ...
                case 24:
                    return ca(t), r = la(M), e === null ? (a = Ea(), a === null && (a = G, o = ha(), a.pooledCache = o, o.refCount++, o !== null && (a.pooledCacheLanes |= n), a = o), t.memoizedState = {
                        parent: r,
                        cache: a
        ...
        function wd(e, t, n, r, i) {
            ...
            gn(function() {
                ...
                if (!(t & 7)) {
                    ...
                    else lr ? sr(e, n) && (x = `onCompositionEnd`) : e === `keydown` && n.keyCode === 229 && (x = `onCompositionStart`);x && (ir && n.locale !== `ko` && (lr || x !== `onCompositionStart` ? x === `onCompositionEnd` && lr && (b = wn()) : (xn = i, Sn = `value` in xn ? xn.value : xn.textContent, lr = !0)), y = Ed(r, x), 0 < y.length && (x = new Hn(x, e, null, n, i), s.push({
                        event: x,
                        listeners: y
                    }), b ? x.data = b : (b = cr(n), b !== null && (x.data = b)))),
                    (b = rr ? ur(e, n) : dr(e, n)) && (x = Ed(r, `onBeforeInput`), 0 < x.length && (y = new Hn(`onBeforeInput`, `beforeinput`, null, n, i), s.push({
                        event: y,
                        listeners: x
                    }), y.data = b)),
                    md(s, e, r, n, i)
...
`).replace(Ad, ``)
        ...
        function kf(e, t, n, r) {
            ...
            switch (e) {
                ...
                case `title`:
                    return null;
                case `style`:
                    return typeof n.precedence == `string` && typeof n.href == `string` ? (t = Af(n.href), n = Ot(a).hoistableStyles, r = n.get(t), r || (r = {
                        type: `style`,
                        instance: null,
                        count: 0,
                        state: null
                ...
                case `link`:
                    ...
                    return null;
                case `script`:
                    return t = n.async, n = n.src, typeof n == `string` && t && typeof t != `function` && typeof t != `symbol` ? (t = Pf(n), n = Ot(a).hoistableScripts, r = n.get(t), r || (r = {
                        type: `script`,
                        instance: null,
                        count: 0,
                        state: null
        ...
        function If(e, t, n) {
            if (t.count++, t.instance === null) switch (t.type) {
                ...
                case `script`:
                    return o = Pf(n.src), (a = e.querySelector(Ff(o))) ? (t.instance = a, k(a), a) : (r = n, (a = mf.get(o)) && (r = h({}, n), zf(r, a)), e = e.ownerDocument || e, a = e.createElement(`script`), k(a), Pd(a, `link`, r), e.head.appendChild(a), t.instance = a);
                case `void`:
                    return null;
                default:
    ...
    S = (e, t) => {
        let n = localStorage.getItem(`vault_` + e);
        if (n !== null) try {
            return JSON.parse(n)
        } catch {
            return n
    ...
    C = ({
        ...
        let [t, n] = (0, b.useState)(S(`themeColor`, `#00ffb3`)), [r, i] = (0, b.useState)(S(`particlesEnabled`, !0)), [a, o] = (0, b.useState)(S(`particleType`, `classic`)), [s, c] = (0, b.useState)(S(`musicEnabled`, !1)), [l, u] = (0, b.useState)(S(`musicVolume`, .5)), [d, f] = (0, b.useState)(S(`cloakMode`, `none`)), [p, m] = (0, b.useState)(S(`panicKey`, `Backquote`)), [h, g] = (0, b.useState)(S(`backgroundTheme`, `default`)), [_, v] = (0, b.useState)(S(`favoriteGames`, []));
        (0, b.useEffect)(() => {
            localStorage.setItem(`vault_themeColor`, JSON.stringify(t))
        }, [t]), (0, b.useEffect)(() => {
            localStorage.setItem(`vault_particlesEnabled`, JSON.stringify(r))
        }, [r]), (0, b.useEffect)(() => {
            localStorage.setItem(`vault_particleType`, JSON.stringify(a))
        }, [a]), (0, b.useEffect)(() => {
            localStorage.setItem(`vault_musicEnabled`, JSON.stringify(s))
        }, [s]), (0, b.useEffect)(() => {
            localStorage.setItem(`vault_musicVolume`, JSON.stringify(l))
        }, [l]), (0, b.useEffect)(() => {
            localStorage.setItem(`vault_cloakMode`, JSON.stringify(d))
        }, [d]), (0, b.useEffect)(() => {
            localStorage.setItem(`vault_panicKey`, JSON.stringify(p))
        }, [p]), (0, b.useEffect)(() => {
            localStorage.setItem(`vault_backgroundTheme`, JSON.stringify(h))
        }, [h]), (0, b.useEffect)(() => {
            localStorage.setItem(`vault_favoriteGames`, JSON.stringify(_))
        }, [_]), (0, b.useEffect)(() => {
            document.body.className = ``, h !== `default` && document.body.classList.add(`theme-${h}`)
        }, [h]), (0, b.useEffect)(() => {
            document.documentElement.style.setProperty(`--accent-color`, t)
        }, [t]), (0, b.useEffect)(() => {
            d === `google` ? (document.title = `Google`, y(`https://www.google.com/favicon.ico`)) : d === `drive` ? (document.title = `My Drive - Google Drive`, y(`https://ssl.gstatic.com/images/branding/product/1x/drive_2020q4_32dp.png`)) : d === `classroom` ? (document.title = `Classes`, y(`https://ssl.gstatic.com/classroom/favicon.png`)) : d === `canvas` ? (document.title = `Dashboard`, y(`https://du11hjcvx0uqb.cloudfront.net/dist/images/favicon-e10d657a73.ico`)) : d === `wikipedia` ? (document.title = `Wikipedia, the free encyclopedia`, y(`https://en.wikipedia.org/static/favicon/wikipedia.ico`)) : (document.title = `⚡ VAULT`, y(`/vault_favicon.png`))
        }, [d]);
        let y = e => {
            let t = document.querySelector(`link[rel~='icon']`);
            t || (t = document.createElement(`link`), t.rel = `icon`, document.getElementsByTagName(`head`)[0].appendChild(t)), t.href = e
        };
    ...
    te = () => {
        let [e, t] = (0, b.useState)([]), [n, r] = (0, b.useState)(!0), [i, a] = (0, b.useState)(!1), [o, s] = (0, b.useState)(null), [c, l] = (0, b.useState)(1), [u, d] = (0, b.useState)(!0), f = async (e, n = !1) => {
            try {
                n ? r(!0) : a(!0);
                let i = await fetch(`https://feeds.gamepix.com/v2/json/?order=quality&page=${e}&pagination=48&sid=1`);
                if (!i.ok) throw Error(`Failed to fetch from GamePix`);
                let o = await i.json(),
                    s = Array.isArray(o.items) ? o.items : Array.isArray(o.data) ? o.data : Array.isArray(o) ? o : [];
                s.length === 0 ? d(!1) : t(e => n ? s : [...e, ...s])
            } catch (e) {
                s(e.message)
            } finally {
                r(!1), a(!1)
    ...
    ne = {
        ...
        baseHtml: `https://cdn.jsdelivr.net/gh/freebuisness/html@main/`
    },
    re = () => {
        let [e, t] = (0, b.useState)([]), [n, r] = (0, b.useState)(!0), [i, a] = (0, b.useState)(null);
        return (0, b.useEffect)(() => {
            let e = !0;
            return (async () => {
                try {
                    let n = await fetch(ne.zones + `?t=` + Date.now());
                    if (!n.ok) throw Error(`Failed to load GN Math Games`);
                    let i = (await n.json()).filter(e => e.id !== -1 && e.id !== `-1`).map(e => ({
                        ...e,
                        id: e.id,
                        title: e.name || `Unknown Game`,
                        image: `${ne.covers}/${e.id}.png`,
                        gameUrl: `${ne.baseHtml}${e.id}.html`,
                        isZone: !0
                    }));
                    e && (t(i), r(!1))
                } catch (t) {
    ...
    w = ({
        ...
        children: [(0, x.jsxs)(`div`, {
        ...
        }), (e === `arcade` || e === `zones` || e === `favorites`) && (0, x.jsx)(`div`, {
            ...
            children: [(0, x.jsx)(`button`, {
                className: `nav-tab ${e===`arcade`?`active`:``}`,
                onClick: () => t(`arcade`),
                children: `Arcade`
            }), (0, x.jsx)(`button`, {
                className: `nav-tab ${e===`zones`?`active`:``}`,
                onClick: () => t(`zones`),
                children: `GN Math Games`
            }), (0, x.jsx)(`button`, {
                className: `nav-tab ${e===`favorites`?`active`:``}`,
                onClick: () => t(`favorites`),
                children: `Favorites`
            }), (0, x.jsx)(`button`, {
                className: `nav-tab ${e===`partners`?`active`:``}`,
                onClick: () => t(`partners`),
                children: `Partners`
            }), (0, x.jsx)(`button`, {
                className: `nav-tab ${e===`settings`?`active`:``}`,
                onClick: () => t(`settings`),
                children: `Settings`
            })]
        })]
    ...
    ie = () => {
        ...
        return (0, b.useEffect)(() => {
            ...
            let r = e.current,
                ...
                a, o = 0,
                s = () => {
                    r.width = window.innerWidth, r.height = window.innerHeight, u()
                };
            ...
            let c = [],
                ...
                u = () => {
                    if (c = [], l = [], n === `matrix`) {
                        let e = Math.ceil(r.width / 20);
                        for (let t = 0; t < e; t++) l[t] = Math.random() * -50
                    } else {
                        let e = n === `rain` ? 100 : n === `stars` ? 200 : 60;
                        for (let t = 0; t < e; t++) c.push(d())
                    }
                },
                d = () => {
                    let e = {
                    ...
                    return n === `snow` ? (e.vy = Math.random() * .5 + .5, e.vx = (Math.random() - .5) * .2, e.size = Math.random() * 2 + 1, e.alpha = Math.random() * .3 + .2) : n === `rain` ? (e.vy = Math.random() * 5 + 10, e.vx = e.vy * .15, e.size = Math.random() * 1.5 + 1, e.length = Math.random() * 15 + 15, e.alpha = Math.random() * .3 + .4) : n === `stars` ? (e.vx = (Math.random() - .5) * .05, e.vy = (Math.random() - .5) * .05, e.flickerSpeed = Math.random() * .005 + .001, e.flickerDir = Math.random() > .5 ? 1 : -1) : (e.vx = (Math.random() - .5) * .5, e.vy = (Math.random() - .5) * .5), e
                };
            s();
            let f = () => {
                let e = getComputedStyle(document.documentElement).getPropertyValue(`--accent-color`).trim() || `#00ffb3`;
                if (n === `matrix`) {
                    if (o++, o % 5 != 0) {
                        a = requestAnimationFrame(f);
                        return
                    }
                    i.fillStyle = `rgba(6, 6, 8, 0.08)`, i.fillRect(0, 0, r.width, r.height), i.globalAlpha = .65, i.fillStyle = e, i.font = `20px monospace`;
                    for (let e = 0; e < l.length; e++) {
                        if (l[e] >= 0) {
                            let t = String.fromCharCode(12448 + Math.floor(Math.random() * 96));
                            i.fillText(t, e * 20, l[e] * 20)
                        }
                        l[e] * 20 > r.height && Math.random() > .95 ? l[e] = 0 : l[e]++
                    }
                    a = requestAnimationFrame(f);
                    return
                }
                i.clearRect(0, 0, r.width, r.height), c.forEach(t => {
                    t.x += t.vx, t.y += t.vy, n === `snow` ? (t.x += Math.sin(t.angle) * .3, t.angle += .02) : n === `stars` && (t.alpha += t.flickerSpeed * t.flickerDir, (t.alpha > .7 || t.alpha < .2) && (t.flickerDir *= -1)), t.x < -50 && (t.x = r.width + 50), t.x > r.width + 50 && (t.x = -50), t.y < -50 && (t.y = r.height + 50), t.y > r.height + 50 && (t.y = -50, n === `rain` && (t.x = Math.random() * r.width)), i.beginPath(), n === `rain` ? (i.moveTo(t.x, t.y), i.lineTo(t.x - t.vx, t.y - t.length), i.strokeStyle = e, i.globalAlpha = t.alpha, i.lineWidth = t.size, i.stroke()) : (i.arc(t.x, t.y, t.size, 0, Math.PI * 2), i.fillStyle = n === `snow` || n === `stars` ? `#ffffff` : e, i.globalAlpha = t.alpha, i.fill())
                }), i.globalAlpha = 1, a = requestAnimationFrame(f)
            };
            return f(), () => {
                window.removeEventListener(`resize`, s), cancelAnimationFrame(a)
            }
        }, [t, n]), t ? (0, x.jsx)(`canvas`, {
            ref: e,
            style: {
                position: `fixed`,
                top: 0,
    ...
    ae = ({
        ...
        let {
            favoriteGames: r,
            setFavoriteGames: i
        } = (0, b.useContext)(ee), a = e.banner_image || e.image || e.thumbnailUrl || e.assets && e.assets.banner || ``, o = r.includes(e.id);
        return (0, x.jsxs)(`div`, {
            ref: n,
            ...
            children: [(0, x.jsxs)(`div`, {
                ...
                children: [(0, x.jsx)(`img`, {
                    ...
                    className: `favorite-btn ${o?`is-fav`:``}`,
                    onClick: t => {
                        t.stopPropagation(), i(o ? r.filter(t => t !== e.id) : [...r, e.id])
                    },
    ...
    oe = ({
        ...
        let s = (0, b.useRef)(),
            c = (0, b.useCallback)(e => {
                t || a || (s.current && s.current.disconnect(), s.current = new IntersectionObserver(e => {
                    e[0].isIntersecting && o && i && i()
                }), e && s.current.observe(e))
            }, [t, a, o, i]);
        return t && e.length === 0 ? (0, x.jsxs)(`div`, {
            className: `grid-message-container glass-panel`,
            children: [(0, x.jsx)(`div`, {
                className: `loader`
            }), (0, x.jsx)(`h2`, {
                children: `Initializing Vault Data...`
            })]
        }) : n && e.length === 0 ? (0, x.jsxs)(`div`, {
            className: `grid-message-container glass-panel error`,
            children: [(0, x.jsx)(`h2`, {
                children: `Connection Error`
            }), (0, x.jsx)(`p`, {
                children: n
            })]
        }) : e.length === 0 ? (0, x.jsx)(`div`, {
            className: `grid-message-container glass-panel`,
            children: (0, x.jsx)(`h2`, {
            ...
            children: [(0, x.jsx)(`div`, {
                className: `game-grid`,
                children: e.map((t, n) => (0, x.jsx)(ae, {
                    innerRef: e.length === n + 1 ? c : null,
                    game: t,
                    onClick: r
                }, t.id || t.namespace || n))
            }), a && (0, x.jsx)(`div`, {
    ...
    se = ({
        ...
        error: n,
        onOpenGame: r
    }) => t && e.length === 0 ? (0, x.jsxs)(`div`, {
        className: `grid-message-container glass-panel`,
        children: [(0, x.jsx)(`div`, {
            className: `loader`
        }), (0, x.jsx)(`h2`, {
            children: `Initializing GN Math Games...`
        })]
    }) : n && e.length === 0 ? (0, x.jsxs)(`div`, {
        className: `grid-message-container glass-panel error`,
        children: [(0, x.jsx)(`h2`, {
    ...
    ce = ({
        ...
        children: [(0, x.jsx)(`div`, {
            ...
            className: `overlay-content form-glass`,
            children: [(0, x.jsx)(`button`, {
                ...
                children: (0, x.jsx)(`iframe`, {
                    src: `https://play.gamepix.com/${e.namespace}/embed?sid=1`,
                    width: `100%`,
                    height: `100%`,
                    frameBorder: `0`,
                    allowFullScreen: !0,
            ...
            children: (0, x.jsxs)(`div`, {
                ...
                children: [(0, x.jsx)(`h2`, {
                    ...
                    children: [(0, x.jsx)(`label`, {
                        ...
                        children: [
                            [`#00ffb3`, `#ff3366`, `#8a2be2`, `#00d2ff`, `#feca57`, `#ff9f43`, `#0abde3`, `#e056fd`].map(n => (0, x.jsx)(`button`, {
                                className: `color-swatch ${e===n?`active`:``}`,
                                style: {
                                    backgroundColor: n
                                },
                                onClick: () => t(n)
                    ...
                    className: `setting-group`,
                    children: [(0, x.jsx)(`label`, {
                        children: `Ambient Background Theme`
                    }), (0, x.jsxs)(`div`, {
                        className: `cloak-options`,
                        style: {
                            flexWrap: `wrap`
                        },
                        children: [(0, x.jsx)(`button`, {
                            className: `cloak-btn ${m===`default`?`active`:``}`,
                            onClick: () => h(`default`),
                            children: `Void`
                        }), (0, x.jsx)(`button`, {
                            className: `cloak-btn ${m===`space`?`active`:``}`,
                            onClick: () => h(`space`),
                            children: `Space Dust`
                        }), (0, x.jsx)(`button`, {
                            className: `cloak-btn ${m===`synthwave`?`active`:``}`,
                            onClick: () => h(`synthwave`),
                            children: `Synthwave`
                        }), (0, x.jsx)(`button`, {
                            className: `cloak-btn ${m===`midnight`?`active`:``}`,
                            onClick: () => h(`midnight`),
                            children: `Midnight`
                        })]
                    })]
                    ...
                    children: [(0, x.jsx)(`label`, {
                        ...
                        className: `toggle-button ${n?`active`:``}`,
                        onClick: () => r(!n),
                        children: n ? `Particles: ON` : `Particles: OFF`
                    }), n && (0, x.jsxs)(`div`, {
                        className: `cloak-options`,
                        style: {
                            flexWrap: `wrap`,
                        ...
                        children: [(0, x.jsx)(`button`, {
                            className: `cloak-btn ${i===`classic`?`active`:``}`,
                            onClick: () => a(`classic`),
                            children: `Classic`
                        }), (0, x.jsx)(`button`, {
                            className: `cloak-btn ${i===`snow`?`active`:``}`,
                            onClick: () => a(`snow`),
                            children: `Snow`
                        }), (0, x.jsx)(`button`, {
                            className: `cloak-btn ${i===`rain`?`active`:``}`,
                            onClick: () => a(`rain`),
                            children: `Rain`
                        }), (0, x.jsx)(`button`, {
                            className: `cloak-btn ${i===`stars`?`active`:``}`,
                            onClick: () => a(`stars`),
                            children: `Stars`
                        }), (0, x.jsx)(`button`, {
                            className: `cloak-btn ${i===`matrix`?`active`:``}`,
                            onClick: () => a(`matrix`),
                            children: `Matrix`
                        })]
                    })]
                    ...
                    children: [(0, x.jsx)(`label`, {
                        ...
                        onClick: () => s(!o),
                        children: o ? `Music: PLAYING` : `Music: MUTED`
                    }), o && (0, x.jsxs)(`div`, {
                    ...
                    className: `setting-group`,
                    children: [(0, x.jsx)(`label`, {
                        children: `Tab Cloak (Stealth Mode)`
                    }), (0, x.jsx)(`p`, {
                        className: `setting-desc`,
                        children: `Disguises your browser tab title and icon.`
                    }), (0, x.jsxs)(`div`, {
                        className: `cloak-options`,
                        style: {
                            flexWrap: `wrap`
                        ...
                        children: [(0, x.jsx)(`button`, {
                            className: `cloak-btn ${u===`none`?`active`:``}`,
                            onClick: () => d(`none`),
                            children: `None`
                        }), (0, x.jsx)(`button`, {
                            className: `cloak-btn ${u===`google`?`active`:``}`,
                            onClick: () => d(`google`),
                            children: `Google`
                        }), (0, x.jsx)(`button`, {
                            className: `cloak-btn ${u===`drive`?`active`:``}`,
                            onClick: () => d(`drive`),
                            children: `Drive`
                        }), (0, x.jsx)(`button`, {
                            className: `cloak-btn ${u===`classroom`?`active`:``}`,
                            onClick: () => d(`classroom`),
                            children: `Classroom`
                        }), (0, x.jsx)(`button`, {
                            className: `cloak-btn ${u===`canvas`?`active`:``}`,
                            onClick: () => d(`canvas`),
                            children: `Canvas`
                        }), (0, x.jsx)(`button`, {
                            className: `cloak-btn ${u===`wikipedia`?`active`:``}`,
                            onClick: () => d(`wikipedia`),
                            children: `Wikipedia`
                        })]
                    })]
                    ...
                    className: `setting-group`,
                    children: [(0, x.jsx)(`label`, {
                        children: `Panic Key (Boss Key)`
                    }), (0, x.jsx)(`p`, {
                        className: `setting-desc`,
                        children: `Press this key anywhere to instantly cloak to Google Classroom.`
                    }), (0, x.jsx)(`input`, {
                        type: `text`,
                        value: f === `Space` ? `Spacebar` : f,
                        readOnly: !0,
                        className: `panic-input`,
                        placeholder: `Click and press a key...`,
                        onKeyDown: e => {
                            e.preventDefault(), p(e.code)
                        },
                        style: {
                            width: `100%`,
                            padding: `10px`,
    ...
    ue = () => {
        let [e, t] = (0, b.useState)(`arcade`), [n, r] = (0, b.useState)(``), [i, a] = (0, b.useState)(null), {
            games: o,
            loading: s,
            error: c,
            loadMore: l,
            ...
            panicKey: v,
            favoriteGames: y
        } = (0, b.useContext)(ee), S = (0, b.useRef)(null), C = o.filter(e => (e.title || ``).toLowerCase().includes(n.toLowerCase())), ne = f.filter(e => (e.title || ``).toLowerCase().includes(n.toLowerCase())), ae = e => {
            let t = window.open(`about:blank`, `_blank`);
            fetch(`${h.baseHtml}${e}.html`).then(e => e.text()).then(e => {
        ...
        `), t.document.close()
                ...
                t.document.write(`Error loading game: ` + e.message), t.document.close()
            })
        };
        return (0, b.useEffect)(() => {
            let e = e => {
                document.activeElement.tagName === `INPUT` && e.code !== `Escape` || e.code === v && window.location.replace(`https://classroom.google.com`)
            };
            return window.addEventListener(`keydown`, e), () => window.removeEventListener(`keydown`, e)
        }, [v]), (0, b.useEffect)(() => {
            g && S.current ? S.current.play().catch(e => console.log(`Autoplay restriction:`, e)) : S.current && S.current.pause()
        }, [g]), (0, b.useEffect)(() => {
            S.current && (S.current.volume = _)
        }, [_]), (0, x.jsxs)(x.Fragment, {
            children: [(0, x.jsx)(ie, {}), (0, x.jsx)(w, {
                activeTab: e,
                setActiveTab: t,
                searchQuery: n,
                setSearchQuery: r
                    ...
                    switch (e) {
                        ...
                        case `zones`:
                            return (0, x.jsx)(se, {
                                ...
                                loading: p,
                                error: m,
                                onOpenGame: e => ae(e.id)
                            });
                        case `favorites`:
                            let e = C.filter(e => y.includes(e.id)),
                                t = ne.filter(e => y.includes(e.id));
                            return (0, x.jsxs)(`div`, {
                                ...
                                }), e.length === 0 && t.length === 0 && (0, x.jsx)(`p`, {
                                    style: {
                                        color: `var(--text-dim)`
                                    },
                                    children: `No favorites yet! Click the star icon on any game to save it here.`
                                }), e.length > 0 && (0, x.jsx)(oe, {
                                    games: e,
                                    loading: !1,
                                    error: null,
                                    onOpenGame: a,
                        ...
                        case `partners`:
                            return (0, x.jsxs)(`div`, {
                                className: `partners-view glass-panel`,
                                children: [(0, x.jsx)(`h2`, {
                                    children: `Our Partners`
                                }), (0, x.jsxs)(`div`, {
                                    className: `partners-list`,
                                    children: [(0, x.jsxs)(`a`, {
                                        href: `https://sites.google.com/view/jaimescheesegrater`,
                                        target: `_blank`,
                                        rel: `noreferrer`,
                                        className: `partner-card glass-panel`,
                                        children: [(0, x.jsx)(`img`, {
                                            src: `https://cdn11.bigcommerce.com/s-mmzke1elww/images/stencil/505w/products/6467/29410/sg200_stainless_steel_shredder_grater_lifestyle__38370.1765312233.jpg?c=1`,
                                            alt: `Jaime's Cheese Grater`,
                                            className: `partner-image`
                                        }), (0, x.jsx)(`h3`, {
                                            children: `Jaime's Cheese Grater`
                                        })]
                                    }), (0, x.jsxs)(`div`, {
                                        className: `partner-card glass-panel placeholder-partner`,
                                        children: [(0, x.jsx)(`h3`, {
                                            children: `GamePix API`
                                        }), (0, x.jsx)(`p`, {
                                            children: `Bringing thousands of HTML5 games directly to your browser natively.`
                                        })]
                                    })]
                                })]
                            });
                ...
                ref: S,
                src: `https://VaultGamesDevelopment/thevault.github.io/assets/bgmusic.mp3`,
                loop: !0
            })]
        })
    };
y.createRoot(document.getElementById(`root`)).render((0, x.jsx)(b.StrictMode, {
    children: (0, x.jsx)(() => (0, x.jsx)(C, {
        children: (0, x.jsx)(ue, {})
    }), {})
}));